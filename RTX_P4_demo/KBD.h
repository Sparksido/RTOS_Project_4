...
// Different orientation for directions
#define IS_LEFT(value) 	(!(value & KBD_DOWN))
#define IS_RIGHT(value) (!(value & KBD_UP))
#define IS_UP(value) 	(!(value & KBD_LEFT))
#define IS_DOWN(value) 	(!(value & KBD_RIGHT))
